...
public class VisitorCtresDsf extends GramaticaBaseVisitor<Value> {
    ...
    public VisitorCtresDsf(Entorno ent, int temporal, int label, int ultimaPosicion, int etiquetaSalida, int etiquetaPosNeg,
                           int etiquetaParaAnd, int etiquetaParaOr, int etiquetaGlobalIf){
        this.pilaEntornos.push(ent);
        this.listC3D.setValores(temporal,label, ultimaPosicion, etiquetaSalida, etiquetaPosNeg, etiquetaParaAnd, etiquetaParaOr, etiquetaGlobalIf);
    }
